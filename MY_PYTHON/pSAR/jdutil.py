...
def jd_to_datetime(jd):
    ...
    """
    # fday, fractral day number
    #
    year, month, fday = jd_to_date(jd)
    frac_days,day = math.modf(fday)
    day           = int(day)
    hour,tmin,sec,micro = days_to_hmsm(frac_days)
    if micro == 1000000:
       micro = 999999
    return datetime(year,month,day,hour,tmin,sec,micro)
